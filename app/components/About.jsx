          ...
          >
            {[...logos, ...logos].map((logo, index) => (
              <img
                ...
                className={`w-auto opacity-70 hover:opacity-100 transition cursor-pointer 
                  ${logo.name.includes("Marriott", "EigenX")
                    ? "mt-[-17px] h-20 md:h-24 scale-150"
                    : logo.name.includes("EigenX")
                    ? "mt-[-17px] h-20 md:h-24 scale-70"
                      : "h-12"
                  }`}
              />
            ))}
